class Game{
    ...
    checkBalleCollision(){
        if(this.balle.y+10 >= this.configuration.boardSize.y){
            if(this.nbVie == 0){
              ...
              document.getElementsByClassName("winlose")[0].getElementsByTagName("h1")[0].innerText = " Too bad";
              this.stopGame();
            }
            else{
    ...
    gameAnimation(inter){
        ...
        if((this.score == 45 && localStorage.getItem("level") == "difficile") || (this.score == 50 && localStorage.getItem("level") != "difficile")) {
          ...
          document.getElementsByClassName("winlose")[0].getElementsByTagName("h1")[0].innerText = " Congrats";
          this.stopGame();
        }
    }
